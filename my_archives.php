                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            <?php 
                                ...
                                $i = 1;
                                $curriculum = $conn->query("SELECT * FROM curriculum_list where id in (SELECT curriculum_id from `archive_list` where submitted_by = '$name')");
                                $cur_arr = array_column($curriculum->fetch_all(MYSQLI_ASSOC),'name','id');
                                $qry = $conn->query("SELECT * from `archive_list` where submitted_by = '$name' order by unix_timestamp(`date_created`) asc ");
