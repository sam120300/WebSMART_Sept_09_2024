                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            ...
                                            <?php if ($row['status'] != 1): ?>
                                                ...
                                                <div class="dropdown-divider"></div>
                                            <?php endif; ?>
                                            <a class="dropdown-item delete_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" data-name="<?= $row['student_id'] ?>"><span class="fa fa-trash text-danger"></span> Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
