            ...
            <div class="container-fluid">
                <form action="" id="update-form">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="student_id" class="control-label text-navy">Student ID</label>
                                <input type="text" name="student_id" id="student_id" placeholder="Student ID" class="form-control form-control-border" required value="<?= isset($student_id) ?$student_id : "" ?>" readonly>
                            </div>
                            <div class="form-group">
